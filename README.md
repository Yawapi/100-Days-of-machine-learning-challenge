...
Day 2. Today was the Native POP (People of the Plains) festival, and I spent the day visiting with many friends and relations instead of working. Thoughts: I made a committment, so although I'm tired I think I will at least watch one video. Siraj Raval posted a video yesterday about coding an API for machine learning, so I'm going to watch that. 
